...
==========================
This script shows how to read and (minimally) preprocess the Thielen et al. 2021 dataset. This dataset can be
...
bandpass = [1.0, 45.0]  # bandpass filter cutoffs in Hz for spectral filtering
...
# Load codes
V = sio.loadmat(os.path.join(path, "resources", "mgold_61_6521_flip_balanced_20.mat"))["codes"].T
